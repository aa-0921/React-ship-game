...
export default class Asteroid {
  ...
  render(state) {
    ...
    context.rotate((this.rotation * Math.PI) / 400);
    ...
    context.restore();
    let chara = new Image();
    // chara.src = "../images/幽霊.svg"; // 画像のURLを指定
    // chara.src = "../images/人形.svg";

    chara.onload = () => {
      context.drawImage(chara, 0, 0, 300, 400);
      // context.drawImage(chara, 0, 0);
    };
    chara.src = "../images/yurei.jpg";
  }
}
